...
uses
  ...
  Dialogs, Menus, ComCtrls, ToolWin, StdCtrls, ExtCtrls, DataConnectUnit,
  Buttons, ADODB, DB;
...
begin
  ...
  try
    OperationStatusText.Lines.Add('Посылка команды...');
    OperatPanelADOC.Execute;
    OperationStatusText.Lines.Add('Выполнено без ошибок.');
  except on E:Exception do
    begin
      OperationStatusText.Lines.Add(E.Message);
      ShowMessage('Ошибка при выполнении! Сообщение: '+E.Message+'.');
    end
  end;
end;
