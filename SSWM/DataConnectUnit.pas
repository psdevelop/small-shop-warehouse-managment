...
res:=-1;
 ...
 try
   ...
   if GetPersonByLoginADOQ.RecordCount<=0 then
     begin
       ShowMessage('Не зарегистрировано ни одного пользователя с именем '''+StorageADOConn.Properties['User Name'].Value+'''.');
     end
   else if GetPersonByLoginADOQ.RecordCount>1 then
     begin
       ShowMessage('Зарегистрировано более одного пользователя с именем '''+StorageADOConn.Properties['User Name'].Value+'''.');
     end
   else
     begin
...
begin
  try
    ...
    begin
      ShowMessage('Неудачное выполнение операции удаления всех позиций документов! Сообщение: '+E.Message+'.');
    end;
  end;
end;
...
begin
  if RealLogin then
    ...
    if GetPersonByLoginADOQ.RecordCount>0 then
    begin
      ShowMessage('Здравствуйте, вы вошли в систему под пользователем '+
...
begin
  ...
  try
    ...
    begin
      ShowMessage('Неудачный поиск типа продуктов по имени типа! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=res;
end;
...
begin
  ...
  try
    ...
    begin
      ShowMessage('Неудачный поиск группы продуктов по имени группы! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=res;
end;
...
begin
  ...
  try
    ...
    begin
      ShowMessage('Неудачное выполнение процедуры добавления нового типа продуктов! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=res;
end;
...
begin
  ...
  try
    ...
    begin
      ShowMessage('Неудачное выполнение процедуры добавления новой группы продуктов по типу! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=res;
end;
...
begin
  ...
  try
    ...
    begin
      ShowMessage('Неудачное выполнение процедуры добавления нового продукта по типу! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=res;
end;
...
begin
  ...
  PersonsADOTable.Active:=False;
   try
    ...
    begin
        ShowMessage('Неудачная активация таблицы пользователей! Сообщение: '+E.Message+'.');
    end;
    end;
end;
...
begin
  ...
  JobTypesADOTable.Active:=False;
   try
    ...
    begin
        ShowMessage('Неудачная активация таблицы справочника видов работ! Сообщение: '+E.Message+'.');
    end;
    end;
end;
...
begin
  DBFImportADOTable.Active:=False;
   try
    ...
    begin
        ShowMessage('Неудачная активация таблицы импорта DBF! Сообщение: '+E.Message+'.');
    end;
    end;
end;
...
begin
   ...
   try
    ...
    begin
        ShowMessage('Неудачная активация таблицы типов товаров! Сообщение: '+E.Message+'.');
    end;
    end;
end;
...
begin
   ...
   try
    ...
    begin
        ShowMessage('Неудачная активация таблицы групп товаров! Сообщение: '+E.Message+'.');
    end;
    end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы системных параметров! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы списка контрагентов! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  if MessageDlg('Удалить документ (накладную)?',mtConfirmation,mbYesNo,0)=mrYes then
    begin
      ...
      begin
          ShowMessage('Неудачное удаление документа из базы! Сообщение: '+E.Message+'.');
      end;
      end;
    end;
end;
...
begin
  if MessageDlg('Удалить позицию документа?',mtConfirmation,mbYesNo,0)=mrYes then
    begin
      ...
      begin
          ShowMessage('Неудачное удаление позиции документа из базы! Сообщение: '+E.Message+'.');
      end;
      end;
    end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы состояния склада! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы справочника производителей! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы справочника типов документов! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы справочника контрагентов! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы справочника товаров! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы документов! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачная активация таблицы позиций документа! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  try
    ...
    MainForm.StatusBar1.Panels[3].Text:=
      'Ошибка сохранения. Сообщение: '+E.Message+'.';
  end;
end;
...
begin
  ...
  if ProductsADOQuery.RecordCount>0 then
    begin
      if InterfaceDM.PrPictureOpenDialog.Execute then
        begin
          ...
          begin
              ShowMessage('Неудачное прохождение инструкции на выгрузку изображения! Сообщение: '+E.Message+'.');
          end;
          end;
    ...
    ShowMessage('Нет ни одного выделенного товара (изделия, материала)!');
end;
...
begin
  ...
  try
      ...
      if ParamByNameADOQ.RecordCount=0 then
        ShowMessage('Не найден параметр '+ParamName+' в базе! Настройте программу!')
      else if ParamByNameADOQ.RecordCount>1 then
          ShowMessage('Найдено более 1-го параметра с именем '+ParamName+' в базе! Настройте программу!')
      else
        begin
  ...
  begin
      ShowMessage('Неудачный запрос параметра '+ParamName+' из базы! Сообщение: '+
      E.Message+'.');
  end;
  end;
  Result:=res;
...
begin
  ...
  if res=-1 then
    begin
      ShowMessage('Установите параметр ''SaleOrderTypeID'' на Панели настроек!');
    end;
  Result:=res;
end;
...
begin
  ...
  if res=-1 then
    begin
      ShowMessage('Установите параметр ''DefaultSupplierID'' на Панели настроек!');
    end;
  Result:=res;
end;
...
begin
  ...
  if res=-1 then
    begin
      ShowMessage('Установите параметр ''DefaultCustomerID'' на Панели настроек!');
    end;
  Result:=res;
end;
...
begin
  ...
  if res=-1 then
    begin
      ShowMessage('Установите параметр ''DefaultIncomeOrderTypeID'' на Панели настроек!');
    end;
  Result:=res;
end;
...
begin
  ...
  if res=-1 then
    begin
      ShowMessage('Установите параметр ''DefaultOutcomeOrderTypeID'' на Панели настроек!');
    end;
  Result:=res;
end;
...
begin
  if DBFImportADOTable.RecordCount>0 then
    ...
    ShowMessage('Нет ни одной записи в DBF-источнике для импорта данных!');
end;
        ...
        begin
          ...
          if DBFImportADOTable.FieldByName('PR_TYPE').AsString<>'' then
            begin
              ...
              if pr_type<0 then
                begin
                  ShowMessage('Неудачное добавление нового типа! Выгрузка будет прервана!');
                  Exit;
                end;
            end
          else
            begin
              ShowMessage('У продукта '''+DBFImportADOTable.FieldByName('NAME').AsString+''' не установлено имя типа. Выгрузка прекращена!');
            end;
          ...
          if DBFImportADOTable.FieldByName('PR_GROUP').AsString<>'' then
            begin
              ...
              if pr_group<0 then
                begin
                  ShowMessage('Неудачное добавление новой группы продуктов к типу! Выгрузка будет прервана!');
                  Exit;
                end;
            end;
          try
          ...
          if new_pr_id>0 then
            ...
            begin
              ShowMessage('Неудачное добавление записи о продукте! Импорт данных будет прерван!');
              Exit;
            end;
...
begin
  ...
  if res=-1 then
    begin
      ShowMessage('Установите параметр ''BuyerKontragentID'' на Панели настроек!');
    end;
  Result:=res;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачное прохождение запроса списка продаж!');
  end;
  end;
end;
...
begin
  ...
  begin
    AddNewPGroup('Новая группа...',PrTypesADOTable.FieldByName('PRODUCTTYPEID').AsInteger);
    DataConnectDM.ReloadProductGroupsTable;
  end
  else
    ShowMessage('Нет выделенного типа товаров!');
end;
...
begin
  if PrTypesADOTable.RecordCount>0 then
  begin
    AddNewProductByType('Новый...',PrTypesADOTable.FieldByName('PRODUCTTYPEID').AsInteger, -1,0,'шт.');
    DataConnectDM.ReloadProductsTable;
  end
  else
    ShowMessage('Нет выделенного типа продукта!');
end;

procedure TDataConnectDM.NewProductTypeDSIExecute(Sender: TObject);
begin
  try
    NewPrTypeADOSP.Parameters.ParamByName('PRODUCTTYPEID').Value := 'Новый...';
    //if not NewPrTypeADOSP.Active then
    //  NewPrTypeADOSP.Active:=True
    //else
    NewPrTypeADOSP.ExecProc;
    ...
    begin
      ShowMessage('Неудачное выполнение процедуры добавления нового типа продукта! Сообщение: '+E.Message+'.');
    end;
  end;
end;
...
begin
  ...
  try
    try
      ...
      begin
        ShowMessage('Неудачный запрос ID накладной! Ошибка: '+E.Message+'.');
      end;
    end;
  finally
...
begin
  ...
  try
    try
      ...
      begin
        ShowMessage('Неудачный запрос ID типа накладной! Ошибка: '+E.Message+'.');
      end;
    end;
  finally
    NewOrderTypeIDADOQ.Active:=False;
...
begin
  ...
  try
    try
      ...
      begin
        ShowMessage('Неудачный запрос ID позиции накладной! Ошибка: '+E.Message+'.');
      end;
    end;
  finally
...
begin
  ...
  begin
    ...
    ShowMessage('Нет выделенной группы товаров!');
  end
  else
    ShowMessage('Не выделено ни одного элемента в таблице "Товары"!');
end;
...
begin
  try
        ...
        begin
          ShowMessage('Неудачная операция связки товара с типом! Сообщение: '+E.Message+'.');
        end;
  end;
end;
...
begin
  try
        ...
        begin
          ShowMessage('Неудачная операция связки товара с группой! Сообщение: '+E.Message+'.');
        end;
  end;
end;
  ...
  if DataConnectDM.ProductsADOQuery.RecordCount>0 then
    begin
      ...
      try
        ...
        begin
          ShowMessage('Неудачная операция пометки товара как старого! Сообщение: '+E.Message+'.');
        end;
      end;
      DataConnectDM.ReloadProductsTable;
    end
...
begin
  ...
  try
    try
      ...
      begin
        ShowMessage('Неудачный запрос ID нового контрагента! Ошибка: '+E.Message+'.');
      end;
    end;
  finally
    NewKontrAgIDADOQ.Active:=False;
...
begin
  ...
  begin
    ...
    begin
      ...
      ShowMessage('В базе нет ни одного типа документа!');
  end
  else
    ShowMessage('Нет выделенного клиента в списке');
end;
...
begin
  if (CurrentSaleOrderID>0) and (LastSaleOrdersADOQ.RecordCount>0) then
    ...
    begin
      ShowMessage('Нет текущей накладной на продажу!');
    end;
end;
...
begin
  ...
  begin
      ShowMessage('Неудачный запрос списка позиций покупки! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      OrderDocID:=-1;
      ShowMessage('Неудачная операция добавления накладной! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=OrderDocID;
end;
...
begin
  ...
  try
    ...
    begin
      OrderItemID:=-1;
      ShowMessage('Неудачная операция добавления позиции накладной! Сообщение: '+E.Message+'.');
    end;
  end;
  Result:=OrderItemID;
end;
...
begin
  ...
  begin
    if OrderDocsADOTable.RecordCount>0 then
      ...
      ShowMessage('Не выделено накладной!');
  end
  else
    ShowMessage('Не выделено ни одного продукта!');
...
begin
  ...
  begin
      ShowMessage('Неудачный запрос позиций документа! Сообщение: '+E.Message+'.');
  end;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ShowMessage('Неудачный запрос товара в справочнике! Сообщение: '+E.Message+'.');
    end;
  end;
end;
